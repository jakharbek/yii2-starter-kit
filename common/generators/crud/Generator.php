 ...
 * @property bool $withRestore
 * @property bool $withDelete
 * @property bool $withUpdate
 * @property bool $withCreate
 * @property string $actionCreateClass
 * @property string $actionUpdateClass
 * @property string $actionDeleteClass
 * @property string $actionViewClass
 * @property string $actionIndexClass
 * @property string $tag
...
class Generator extends \yii\gii\Generator
{
    ...
    public $actionCreateClass = 'yii\rest\CreateAction';
    public $actionUpdateClass = 'yii\rest\UpdateAction';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['path', 'tag', 'actionCreateClass', 'actionUpdateClass', 'actionDeleteClass', 'actionViewClass', 'actionIndexClass', 'actionRestoreClass'], 'string'],
            [['withRestore', 'withDelete', 'withUpdate', 'withCreate', 'withView', 'withIndex'], 'safe'],
        ]);
    }
